...
const faqs = [
 ...
 // Φωτιστικά Σώματα
  ...
  { category: "Πιστοποιητικά ΔΕΗ (ΥΔΕ)", question: "Πόση διάρκεια έχει το Πιστοποιητικό ΔΕΗ;", answer: "Για κατοικίες ισχύει 10 χρόνια και για επαγγελματικούς χώρους 5 χρόνια." },
